...
module.exports = {
    ...
    run : async (client, interaction, args) => {	
        ...
        let probotID = await db.get(`probot_${interaction.guild.id}_${client.user.id}`)
        ...
        if(!admins || admins.length === 0) admins = "No Admins Yet"
        ...
        if(admins !== "No Admins Yet") {
            ...
            embed.addFields({
                name: "Admins",
                value: `${admins ? admins : "No Admins Yet"}`
            }
            )
