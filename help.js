...
module.exports = {
    ...
    run : async (client, interaction ) => {
        ...
        .addFields({
            ...
            name: `add`,
          value: `Adds Accounts To A Specifc Category [<prefix>add <type> <accounts>] [للبريفكس]`
        } ,{
        ...
        name: `blacklist`,
        value: `**Blacklist A User**`,
     } , {
        name: `remove-blacklist`,
        value: `**Remove The Blacklist From A User**`,
      } , {
					name: `add-emoji`,
					value: `**Adds An Emoji To The Specified Category**`
				} , {
					name: `remove-emoji`,
					value: `**Removes The Category's Emoji.**`
				})
        ...
        .addFields({
            name: `config`,
            value: `**تظهر اعدادات البوت كاملة**`,
        } , {
            name: `set-price`,
